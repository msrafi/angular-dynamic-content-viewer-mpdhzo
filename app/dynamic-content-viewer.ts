...
import { EmbeddableComponent1 } from './embeddable1.component';

export const embeddedComponents = [EmbeddableComponent, EmbeddableComponent1];
...
export class ContentViewer {
  ...
  private embeddedComponentFactories: Map<string, ComponentFactory<any>> =
    new Map();
  ...
  private build(content) {
    ...
    this.embeddedComponentFactories.forEach((factory, selector) => {
      const embeddedComponentElements =
        this.hostElement.querySelectorAll(selector);
